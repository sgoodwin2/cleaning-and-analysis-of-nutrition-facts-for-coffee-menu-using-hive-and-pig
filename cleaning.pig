...
REGISTER '/home/stang/CA4022-Starbucks-Nutrition-cleaning-analysis/data/piggybank.jar';

-- Load and clean data from 'starbucks-menu-nutrition-drinks.csv'
data = LOAD '/home/stang/CA4022-Starbucks-Nutrition-cleaning-analysis/data/archive/starbucks-menu-nutrition-drinks.csv' USING org.apache.pig.piggybank.storage.CSVLoader() AS (product:chararray, calories:chararray, fat_g:chararray, carb_g:chararray, fiber_g:chararray, protein:chararray, sodium:chararray);
...
STORE cleaned_data INTO '/home/stang/CA4022-Starbucks-Nutrition-cleaning-analysis/outputs/cleanDrinks.csv' USING PigStorage(',');

-- starbucks_drinkMenu_expanded.csv

-- Load and clean data from 'starbucks_drinkMenu_expanded.csv'
data = LOAD '/home/stang/CA4022-Starbucks-Nutrition-cleaning-analysis/data/archive/starbucks_drinkMenu_expanded.csv' USING org.apache.pig.piggybank.storage.CSVLoader() AS (bev_cat:chararray, bev:chararray, bev_prep:chararray, calories:chararray, tot_fat:chararray, trans_fat:chararray, sat_fat:chararray, sodium:chararray, tot_carb:chararray, chol:chararray, diet_fat:chararray, sugar:chararray, protein:chararray, vit_a:chararray, vit_c:chararray, calc:chararray, iron:chararray, caff:chararray);
...
-- Store the cleaned data into a CSV file
STORE cleaned_data INTO '/home/stang/CA4022-Starbucks-Nutrition-cleaning-analysis/outputs/cleanExpandedDrinks.csv' USING PigStorage(',');
